 ...
 */
 ...
 $(function () {
     ...
     * 3.给计算总价中的全选框也赋值为表头的选中状态（true/ false）
     */
    //表头的全选
    $theadInput.change(function () {
        var checkState = $(this).prop('checked');//获取全选框中的选择状态
       ...
       */
        ...
        */
         ...
         */
         ...
         function allTotal() {  //定义一个变量 用于保存总价
             var allPrice = 0;  //定义一个变量 用于保存已选商品数量
             var selectedCount = 0;
